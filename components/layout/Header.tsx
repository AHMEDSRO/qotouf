  ...
  return (
    <header className="bg-primary text-primary-foreground">
      <div className="mx-auto flex max-w-6xl flex-wrap items-center justify-between gap-4 px-4 py-4">
        <Link href={`/${locale}`} className="flex items-center rounded-card bg-surface px-3 py-2 shadow-sm">
          <Image src="/logo.jpg" alt={dict.brand} width={936} height={458} className="h-14 w-auto" priority />
        </Link>
